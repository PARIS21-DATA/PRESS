...
attributes(df_survey$usd_commitment)$variable.labels <- "numerised original commitment data collected from the survey, replaced NAs with 0"
attributes(df_survey$cost_estimate)$variable.labels <- "original cost estimate data collected from the survey"
attributes(df_survey$usd_costestimate)$variable.labels <- "original cost estimate data collected from the survey, replaced NAs with 0"
