...
head(df_crs$projecttitle_stem)
head(df_crs$text_detection_gender)

df_crs$text_detection_gender %>% table

df_crs_results <- read_rds(crs_path_new)
df_crs_results$text_detection_gender %>% table
